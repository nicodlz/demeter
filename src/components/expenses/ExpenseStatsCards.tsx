  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4">
      <Card>
        ...
        <CardContent>
          <div className="text-lg sm:text-2xl font-bold">{mask(formatCurrency(totalAmount, currency))}</div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-lg sm:text-2xl font-bold">{mask(formatCurrency(lastCompletedMonth.total, currency))}</div>
      ...
      <Card>
        ...
        <CardContent>
          <div className={`text-lg sm:text-2xl font-bold ${isIncrease ? 'text-destructive' : 'text-green-500'}`}>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-lg sm:text-2xl font-bold">{mask(formatCurrency(dailyAverage, currency))}</div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-lg sm:text-2xl font-bold">{mask(formatCurrency(avgPerTransaction, currency))}</div>
